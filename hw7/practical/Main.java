...
public class Main  {
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        System.out.println("Deep Clone Alpha Department: " + deepCloneDepartment);
        ...
        System.out.println("Changed Address of Deep Clone Alpha Department: " + deepCloneDepartment);
        System.out.println("Original Alpha Department: " + department);
