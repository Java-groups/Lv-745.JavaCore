...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Enter two strings, like «IT» and «IT Academy», each one from new line: ");
        ...
        System.out.println("Enter {\"surname\" \"name\" \"patronymic\"} each divided by space: ");
